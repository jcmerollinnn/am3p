...
# Input dataset (train)
cfg.fake_data_provider = lambda: FolderDataProvider(folder='/home/jc/exposure/user_study_ui/data/outputs', default_batch_size=cfg.batch_size)
# Input dataset (test)
cfg.fake_data_provider_test = lambda: FolderDataProvider(folder='/home/jc/exposure/user_study_ui/data/inputs/outputs', default_batch_size=cfg.batch_size)
# Target dataset
cfg.real_data_provider = lambda: FolderDataProvider(folder='/home/jc/exposure/user_study_ui/data/inputs/0', default_batch_size=cfg.batch_size)
